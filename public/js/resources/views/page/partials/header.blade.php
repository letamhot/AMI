                    ...
                    <div class="col-sm-6">
                        <div class="contactinfo">
                            ...
                            <ul class="nav nav-pills">
                                ...
                                --}}
                                <li><a href="{{ route('amibakeshop') }}"><i class="fa fa-home">Khách</i></a></li>
                            </ul>

                            @else
                            <ul class="nav nav-pills">
                                <li><a href="#"><i class="fa fa-phone"></i> {{ Auth::user()->phone }}</a></li>
                                <li><a href="{{ route('amibakeshop') }}"><i
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="logo pull-left">
                            <a href="{{ route('amibakeshop') }}"><img src="img/logo.jpg" width="80px" height="60px"
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="mainmenu pull-left">
                            <ul class="nav navbar-nav collapse navbar-collapse">
                                <li><a href="{{ route('amibakeshop') }}" class="active">Trang chủ</a></li>
