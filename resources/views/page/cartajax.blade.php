<section id="cart_items">
    <div class="container">
        ...
        <div class="breadcrumbs">
            <ol class="breadcrumb">
                <li><a href="{{ route('amibakeshop') }}">Trang chủ</a></li>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="cart_product">
                                <h4 style="width:75%"><a href="{{ route('productdetail', $product->id) }}">{{ $item->name }}</a></h4>
                            </td>
                            <td class="cart_price">
            ...
            <div class="col-lg-4">
                <div class="discount-coupon">
                    ...
                    <div>
                        ...
                        <div class="red card box" style="display: block">Ít nhất<strong> 30' - 1h
                            </strong>giao hàng
                        </div>
                        ...
                        <div class="green card box">Tài khoản ngân hàng:
                            ...
                            <br>- Số tài khoản: 531169643
                            <br>- Tên chủ tài khoản: Lê Văn Tám
                            <br>- Bank BIDV, Quảng Bình
                        </div>
                    </div>
                </div>
                {{-- <div class="discount-coupon">
